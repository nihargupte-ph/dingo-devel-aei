...
setproctitle.setproctitle(f"bilby")
...
logger.info("Saving data plots to {}".format(save_dir))
bilby.core.utils.check_directory_exists_and_if_not_mkdir(save_dir)
ifo_list.plot_data(outdir=save_dir, label=save_idx)

# Save strain data
ifo_list.save_data(save_dir, save_idx)
