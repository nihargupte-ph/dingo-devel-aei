...
class WaveformGenerator:
    ...
    def _convert_parameters(
        ...
        target_functions_dict = {
            ...
            "SimIMRSpinAlignedEOBModesEcc_opt1": LS.SimIMRSpinAlignedEOBModesEcc_opt1,
            "SimIMRSpinAlignedEOBModes": LS.SimIMRSpinAlignedEOBModes,
            "SimIMRSpinAlignedEOBWaveformEcc_opt": LS.SimIMRSpinAlignedEOBWaveformEcc_opt
        }
        ...
        elif target_function == "SimIMRSpinAlignedEOBWaveformEcc_opt":
        ...
        elif target_function == "SimIMRSpinAlignedEOBModesEcc_opt1":
            if self.approximant == 109:
                approx = 41
            domain_pars = (delta_t, f_min, f_ref)
        ...
        elif target_function == "SimIMRSpinAlignedEOBModes":
